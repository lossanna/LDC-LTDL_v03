...
model02.psm
summary(model02.psm) # 31 treated matched

# Diagnostic love plot
model02.loveplot <- love.plot(model02.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "2. Blue Mountains: Vegetation disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model02.loveplot
...
model03.psm
summary(model03.psm) # 42 treated matched

# Diagnostic love plot
model03.loveplot <- love.plot(model03.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "3. Blue Mountains: Post-burn herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model03.loveplot
...
model04.psm
summary(model04.psm) # 33 treated matched

# Diagnostic love plot
model04.loveplot <- love.plot(model04.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "4. Middle Rockies: Herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model04.loveplot
...
model05.psm
summary(model05.psm) # 76 treated matched

# Diagnostic love plot
model05.loveplot <- love.plot(model05.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "5. Southern Rockies: Herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model05.loveplot
...
model06.psm
summary(model06.psm) # 37 treated matched

# Diagnostic love plot
model06.loveplot <- love.plot(model06.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "6. Southern Rockies: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model06.loveplot
...
model07.psm
summary(model07.psm) # 28 treated matched

# Diagnostic love plot
model07.loveplot <- love.plot(model07.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "7. Southern Rockies: Vegetation disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model07.loveplot
...
model08.psm
summary(model08.psm) # 51 treated matched

# Diagnostic love plot
model08.loveplot <- love.plot(model08.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "8. Northwestern Great Plains: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model08.loveplot
...
model09.psm
summary(model09.psm) # 153 treated matched

# Diagnostic love plot
model09.loveplot <- love.plot(model09.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "9. Snake River Plain: Post-burn aerial seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model09.loveplot
...
model10.psm
summary(model10.psm) # 77 treated matched
...
model10.plot <- model10.pred |>
  ...
  theme_bw() +
  theme(axis.text.x = element_text(color = "black")) +
  labs(title = "10. Snake River Plain: Post-burn aerial & drill seeding",
       x = NULL)
model10.plot
...
model11.psm
summary(model11.psm) # 87 treated matched

# Diagnostic love plot
model11.loveplot <- love.plot(model11.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "11. Snake River Plain: Post-burn closure") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model11.loveplot
...
model12.psm
summary(model12.psm) # 36 treated matched

# Diagnostic love plot
model12.loveplot <- love.plot(model12.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "12. Snake River Plain: Post-burn drill seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model12.loveplot
...
model13.psm
summary(model13.psm) # 28 treated matched

# Diagnostic love plot
model13.loveplot <- love.plot(model13.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "13. Snake River Plain: Post-burn herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model13.loveplot
...
model14.psm
summary(model14.psm) # 82 treated matched

# Diagnostic love plot
model14.loveplot <- love.plot(model14.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "14. Northern Basin and Range: Drill seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model14.loveplot
...
model15.psm
summary(model15.psm) # 61 treated matched

# Diagnostic love plot
model15.loveplot <- love.plot(model15.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "15. Northern Basin and Range: Drill seeding & soil disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model15.loveplot
...
model16.psm
summary(model16.psm) # 259 treated matched

# Diagnostic love plot
model16.loveplot <- love.plot(model16.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "16. Northern Basin and Range: Herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model16.loveplot
...
model17.psm
summary(model17.psm) # 158 treated matched

# Diagnostic love plot
model17.loveplot <- love.plot(model17.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "17. Northern Basin and Range: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model17.loveplot
...
model18.psm
summary(model18.psm) # 105 treated matched

# Diagnostic love plot
model18.loveplot <- love.plot(model18.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "18. Northern Basin and Range: Vegetation disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model18.loveplot
...
model19.psm
summary(model19.psm) # 542 treated matched

# Diagnostic love plot
model19.loveplot <- love.plot(model19.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "19. Northern Basin and Range: Post-burn aerial seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model19.loveplot
...
model20.psm
summary(model20.psm) # 88 treated matched

# Diagnostic love plot
model20.loveplot <- love.plot(model20.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "20. Northern Basin and Range: Post-burn aerial & drill seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model20.loveplot
...
model21.psm
summary(model21.psm) # 151 treated matched

# Diagnostic love plot
model21.loveplot <- love.plot(model21.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "21. Northern Basin and Range: Post-burn closure") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model21.loveplot
...
model22.psm
summary(model22.psm) # 217 treated matched

# Diagnostic love plot
model22.loveplot <- love.plot(model22.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "22. Northern Basin and Range: Post-burn drill seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model22.loveplot
...
model23.psm
summary(model23.psm) # 370 treated matched

# Diagnostic love plot
model23.loveplot <- love.plot(model23.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "23. Northern Basin and Range: Post-burn herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model23.loveplot
...
model24.psm
summary(model24.psm) # 56 treated matched

# Diagnostic love plot
model24.loveplot <- love.plot(model24.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "24. Northern Basin and Range: Post-burn seedling planting") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model24.loveplot
...
model25.psm
summary(model25.psm) # 31 treated matched

# Diagnostic love plot
model25.loveplot <- love.plot(model25.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "25. Central Basin and Range: Aerial seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model25.loveplot
...
model25.matched <- model25.matched |>
  mutate(trt_control = if_else(trt_binary == 1, "Aerial seeding", "Control")) |>
  mutate(trt_control = factor(trt_control, levels = c("Control", "Aerial seeding")))
...
model26.psm
summary(model26.psm) # 36 treated matched

# Diagnostic love plot
model26.loveplot <- love.plot(model26.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "26. Central Basin and Range: Drill seeding & soil disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model26.loveplot
...
model26.pred # NS for both control & treated (not different from 0)
...
model27.psm
summary(model27.psm) # 31 treated matched

# Diagnostic love plot
model27.loveplot <- love.plot(model27.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "27. Central Basin and Range: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model27.loveplot
...
model28.psm
summary(model28.psm) # 99 treated matched

# Diagnostic love plot
model28.loveplot <- love.plot(model28.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "28. Central Basin and Range: Vegetation disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model28.loveplot
...
model30.psm
summary(model30.psm) # 88 treated matched

# Diagnostic love plot
model30.loveplot <- love.plot(model30.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "30. Central Basin and Range: Post-burn drill seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model30.loveplot
...
model30.pred # Control NS (not different from 0)
...
model31.psm
summary(model31.psm) # 38 treated matched

# Diagnostic love plot
model31.loveplot <- love.plot(model31.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "31. Central Basin and Range: Post-burn ground seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model31.loveplot
...
model31.pred # NS for both control & treated (not different from 0)
...
model33.psm
summary(model33.psm) # 37 treated matched

# Diagnostic love plot
model33.loveplot <- love.plot(model33.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "33. Wyoming Basin: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model33.loveplot
...
model34.psm
summary(model34.psm) # 60 treated matched

# Diagnostic love plot
model34.loveplot <- love.plot(model34.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "34. Colorado Plateaus: Aerial seeding & soil disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model34.loveplot
...
model35.psm
summary(model35.psm) # 47 treated matched

# Diagnostic love plot
model35.loveplot <- love.plot(model35.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "35. Colorado Plateaus: Herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model35.loveplot
...
model36.psm
summary(model36.psm) # 76 treated matched

# Diagnostic love plot
model36.loveplot <- love.plot(model36.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "36. Colorado Plateaus: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model36.loveplot
...
model37.psm
summary(model37.psm) # 40 treated matched

# Diagnostic love plot
model37.loveplot <- love.plot(model37.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "37. Colorado Plateaus: Soil disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model37.loveplot
...
model38.psm
summary(model38.psm) # 34 treated matched

# Diagnostic love plot
model38.loveplot <- love.plot(model38.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "38. Colorado Plateaus: Vegetation disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model38.loveplot
...
model39.psm
summary(model39.psm) # 58 treated matched

# Diagnostic love plot
model39.loveplot <- love.plot(model39.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "39. Colorado Plateaus: Post-burn aerial seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model39.loveplot
...
model40.psm
summary(model40.psm) # 49 treated matched

# Diagnostic love plot
model40.loveplot <- love.plot(model40.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "40. AZ/NM Plateau: Herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model40.loveplot
...
model40.plot <- model40.pred |>
  ...
  theme(axis.text.x = element_text(color = "black")) +
  labs(x = NULL,
       title = "40. AZ/NM Plateau: Herbicide")
model40.plot
...
model41.psm
summary(model41.psm) # 28 treated matched

# Diagnostic love plot
model41.loveplot <- love.plot(model41.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "41. AZ/NM Plateau: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model41.loveplot
...
model42.psm
summary(model42.psm) # 34 treated matched

# Diagnostic love plot
model42.loveplot <- love.plot(model42.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "42. AZ/NM Plateau: Seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model42.loveplot
...
model42.matched <- model42.matched |>
  mutate(trt_control = if_else(trt_binary == 1, "Seeding", "Control")) |>
  mutate(trt_control = factor(trt_control, levels = c("Control", "Seeding")))
...
model42.pred # Seeding NS (not different from 0)
...
model44.psm
summary(model44.psm) # 65 treated matched

# Diagnostic love plot
model44.loveplot <- love.plot(model44.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "44. Mojave Basin and Range: Post-burn aerial seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model44.loveplot

# eCDF plots
bal.plot(model44.psm, which = "both", type = "ecdf")
bal.plot(model44.psm, var = "BareSoil_FH", which = "both", type = "ecdf")
bal.plot(model44.psm, var = "TotalFoliarCover", which = "both", type = "ecdf")
bal.plot(model44.psm, var = "ForbCover_AH", which = "both", type = "ecdf")
bal.plot(model44.psm, var = "GramCover_AH", which = "both", type = "ecdf")
bal.plot(model44.psm, var = "ShrubCover_AH", which = "both", type = "ecdf")
bal.plot(model44.psm, var = "Gap100plus", which = "both", type = "ecdf")
bal.plot(model44.psm, var = "CETWI", which = "both", type = "ecdf")
bal.plot(model44.psm, var = "sandtotal_0_cm", which = "both", type = "ecdf")

# Density plots
bal.plot(model44.psm, which = "both")
bal.plot(model44.psm, var = "BareSoil_FH", which = "both")
bal.plot(model44.psm, var = "TotalFoliarCover", which = "both")
bal.plot(model44.psm, var = "ForbCover_AH", which = "both")
bal.plot(model44.psm, var = "GramCover_AH", which = "both")
bal.plot(model44.psm, var = "ShrubCover_AH", which = "both")
bal.plot(model44.psm, var = "Gap100plus", which = "both")
bal.plot(model44.psm, var = "CETWI", which = "both")
bal.plot(model44.psm, var = "sandtotal_0_cm", which = "both")

# Bar plot
bal.plot(model44.psm, var = "MLRARSYM", which = "both")

# eQQ plots
plot(model44.psm, type = "qq")

# Matched data
model44.matched <- match_data(model44.psm)

# Create trt_control variable
model44.matched <- model44.matched |>
  mutate(trt_control = if_else(trt_binary == 1, "Post-burn aerial seeding", "Post-burn control")) |>
  mutate(trt_control = factor(trt_control, levels = c("Post-burn control", "Post-burn aerial seeding")))
...
model44.lm <- lm(
  ln_q ~ trt_control * (
    BareSoil_FH_scaled + TotalFoliarCover_scaled + ForbCover_AH_scaled + GramCover_AH_scaled +
      ShrubCover_AH_scaled + Gap100plus_scaled + CETWI_scaled + sandtotal_0_cm_scaled),
  data = model44.matched,
  weights = weights
)

# G computation to estimate marginal effects
model44.pred <- avg_predictions(
  model = model44.lm,
  variables = "trt_control",
  vcov = ~subclass,
  by = "trt_control"
...
model45.psm
summary(model45.psm) # 64 treated matched

# Diagnostic love plot
model45.loveplot <- love.plot(model45.psm, stars = "std",           
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "45. Chihuahuan Desert: Herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model45.loveplot

# eCDF plots
bal.plot(model45.psm, which = "both", type = "ecdf")
bal.plot(model45.psm, var = "BareSoil_FH", which = "both", type = "ecdf")
bal.plot(model45.psm, var = "TotalFoliarCover", which = "both", type = "ecdf")
bal.plot(model45.psm, var = "ForbCover_AH", which = "both", type = "ecdf")
bal.plot(model45.psm, var = "GramCover_AH", which = "both", type = "ecdf")
bal.plot(model45.psm, var = "ShrubCover_AH", which = "both", type = "ecdf")
bal.plot(model45.psm, var = "Gap100plus", which = "both", type = "ecdf")
bal.plot(model45.psm, var = "CETWI", which = "both", type = "ecdf")
bal.plot(model45.psm, var = "sandtotal_0_cm", which = "both", type = "ecdf")

# Density plots
bal.plot(model45.psm, which = "both")
bal.plot(model45.psm, var = "BareSoil_FH", which = "both")
bal.plot(model45.psm, var = "TotalFoliarCover", which = "both")
bal.plot(model45.psm, var = "ForbCover_AH", which = "both")
bal.plot(model45.psm, var = "GramCover_AH", which = "both")
bal.plot(model45.psm, var = "ShrubCover_AH", which = "both")
bal.plot(model45.psm, var = "Gap100plus", which = "both")
bal.plot(model45.psm, var = "CETWI", which = "both")
bal.plot(model45.psm, var = "sandtotal_0_cm", which = "both")

# Bar plot
bal.plot(model45.psm, var = "MLRARSYM", which = "both")

# eQQ plots
plot(model45.psm, type = "qq")

# Matched data
model45.matched <- match_data(model45.psm)

# Create trt_control variable
model45.matched <- model45.matched |>
  mutate(trt_control = if_else(trt_binary == 1, "Herbicide", "Control")) |>
  mutate(trt_control = factor(trt_control, levels = c("Control", "Herbicide")))
...
model45.lm <- lm(
  ln_q ~ trt_control * (
    BareSoil_FH_scaled + TotalFoliarCover_scaled + ForbCover_AH_scaled + GramCover_AH_scaled +
      ShrubCover_AH_scaled + Gap100plus_scaled + CETWI_scaled + sandtotal_0_cm_scaled),
  data = model45.matched,
  weights = weights
)

# G computation to estimate marginal effects
model45.pred <- avg_predictions(
  model = model45.lm,
  variables = "trt_control",
  vcov = ~subclass,
  by = "trt_control"
...
model45.pred # Herbicide NS (not different from 0)
...
model46.psm
summary(model46.psm) # 30 treated matched

# Diagnostic love plot
model46.loveplot <- love.plot(model46.psm, stars = "std",
                              thresholds = c(m = 0.2, v = 2)) +
  labs(title = "46. AZ/NM Mountains: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model46.loveplot

# eCDF plots
bal.plot(model46.psm, which = "both", type = "ecdf")
bal.plot(model46.psm, var = "BareSoil_FH", which = "both", type = "ecdf")
bal.plot(model46.psm, var = "TotalFoliarCover", which = "both", type = "ecdf")
bal.plot(model46.psm, var = "ForbCover_AH", which = "both", type = "ecdf")
bal.plot(model46.psm, var = "GramCover_AH", which = "both", type = "ecdf")
bal.plot(model46.psm, var = "ShrubCover_AH", which = "both", type = "ecdf")
bal.plot(model46.psm, var = "Gap100plus", which = "both", type = "ecdf")
bal.plot(model46.psm, var = "CETWI", which = "both", type = "ecdf")
bal.plot(model46.psm, var = "sandtotal_0_cm", which = "both", type = "ecdf")

# Density plots
bal.plot(model46.psm, which = "both")
bal.plot(model46.psm, var = "BareSoil_FH", which = "both")
bal.plot(model46.psm, var = "TotalFoliarCover", which = "both")
bal.plot(model46.psm, var = "ForbCover_AH", which = "both")
bal.plot(model46.psm, var = "GramCover_AH", which = "both")
bal.plot(model46.psm, var = "ShrubCover_AH", which = "both")
bal.plot(model46.psm, var = "Gap100plus", which = "both")
bal.plot(model46.psm, var = "CETWI", which = "both")
bal.plot(model46.psm, var = "sandtotal_0_cm", which = "both")

# Bar plot
bal.plot(model46.psm, var = "MLRARSYM", which = "both")

# eQQ plots
plot(model46.psm, type = "qq")

# Matched data
model46.matched <- match_data(model46.psm)

# Create trt_control variable
model46.matched <- model46.matched |>
  mutate(trt_control = if_else(trt_binary == 1, "Prescribed burn", "Control")) |>
  mutate(trt_control = factor(trt_control, levels = c("Control", "Prescribed burn")))
...
model46.lm <- lm(
  ln_q ~ trt_control * (
    BareSoil_FH_scaled + TotalFoliarCover_scaled + ForbCover_AH_scaled + GramCover_AH_scaled +
      ShrubCover_AH_scaled + Gap100plus_scaled + CETWI_scaled + sandtotal_0_cm_scaled),
  data = model46.matched,
  weights = weights
)

# G computation to estimate marginal effects
model46.pred <- avg_predictions(
  model = model46.lm,
  variables = "trt_control",
  vcov = ~subclass,
  by = "trt_control"
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model01_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model01.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model01_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model01.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model02_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model02.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model02_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model02.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model03_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model03.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model03_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model03.plot
dev.off()
...
# 4. Middle Rockies: Herbicide
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model04_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model04.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model04_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model04.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model05_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model05.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model05_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model05.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model06_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model06.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model06_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model06.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model07_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model07.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model07_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model07.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model08_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model08.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model08_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model08.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model09_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model09.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model09_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model09.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model10_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model10.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model10_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model10.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model11_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model11.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model11_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model11.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model12_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model12.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model12_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model12.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model13_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model13.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model13_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model13.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model14_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model14.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model14_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model14.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model15_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model15.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model15_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model15.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model16_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model16.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model16_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model16.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model17_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model17.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model17_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model17.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model18_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model18.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model18_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model18.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model19_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model19.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model19_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model19.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model20_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model20.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model20_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model20.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model21_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model21.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model21_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model21.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model22_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model22.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model22_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model22.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model23_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model23.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model23_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model23.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model24_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model24.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model24_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model24.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model25_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model25.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model25_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model25.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model26_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model26.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model26_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model26.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model27_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model27.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model27_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model27.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model28_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model28.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model28_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model28.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model29_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model29.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model29_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model29.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model30_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model30.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model30_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model30.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model31_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model31.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model31_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model31.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model32_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model32.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model32_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model32.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model33_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model33.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model33_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model33.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model34_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model34.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model34_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model34.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model35_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model35.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model35_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model35.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model36_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model36.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model36_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model36.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model37_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model37.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model37_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model37.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model38_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model38.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model38_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model38.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model39_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model39.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model39_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model39.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model40_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model40.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model40_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model40.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model41_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model41.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model41_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model41.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model42_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model42.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model42_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model42.plot
dev.off()
...
#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model43_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model43.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model44_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model44.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model44_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model44.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model45_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model45.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model45_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model45.plot
dev.off()
...
#   Love plot
tiff("figures/2026-06_PSM-and-permutation-tests-2/model46_loveplot.tiff",
     units = "in", width = 6, height = 4, res = 150)
model46.loveplot
dev.off()

#   Treatment effect
tiff("figures/2026-06_PSM-and-permutation-tests-2/model46_average-treatment-effect.tiff",
     units = "in", width = 6, height = 4, res = 150)
model46.plot
dev.off()
