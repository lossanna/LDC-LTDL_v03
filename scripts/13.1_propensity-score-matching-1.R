...
model01.psm
summary(model01.psm) # 30 treated matched
...
model02.psm
summary(model02.psm) # 49 treated matched
...
model03.psm
summary(model03.psm) # 28 treated matched
...
model04.psm
summary(model04.psm) # 34 treated matched
...
model05.psm
summary(model05.psm) # 41 treated matched
...
model06.psm
summary(model06.psm) # 96 treated matched
...
model07.psm
summary(model07.psm) # 31 treated matched
...
model08.psm
summary(model08.psm) # 42 treated matched
...
model09.psm
summary(model09.psm) # 31 treated matched
...
model11.psm
summary(model11.psm) # 31 treated matched
...
model12.psm
summary(model12.psm) # 99 treated matched
...
model13.psm
summary(model13.psm) # 345 treated matched
...
model14.psm
summary(model14.psm) # 88 treated matched
...
model15.psm
summary(model15.psm) # 38 treated matched
...
model16.psm
summary(model16.psm) # 80 treated matched
...
model17.psm
summary(model17.psm) # 64 treated matched
...
model18.psm
summary(model18.psm) # 60 treated matched
...
model19.psm
summary(model19.psm) # 47 treated matched
...
model20.psm
summary(model20.psm) # 76 treated matched
...
model21.psm
summary(model21.psm) # 40 treated matched
...
model22.psm
summary(model22.psm) # 34 treated matched
...
model23.psm
summary(model23.psm) # 58 treated matched
...
model24.psm
summary(model24.psm) # 33 treated matched
...
model25.psm
summary(model25.psm) # 65 treated matched
...
model26.psm
summary(model26.psm) # 82 treated matched


# Diagnostic love plot
model26.loveplot <- love.plot(model26.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "26. Northern Basin and Range: Drill seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model26.loveplot
...
model27.psm
summary(model27.psm) # 61 treated matched


# Diagnostic love plot
model27.loveplot <- love.plot(model27.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "27. Northern Basin and Range: Drill seeding & soil disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model27.loveplot
...
model28.psm
summary(model28.psm) # 259 treated matched


# Diagnostic love plot
model28.loveplot <- love.plot(model28.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "28. Northern Basin and Range: Herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model28.loveplot
...
model29.psm
summary(model29.psm) # 158 treated matched


# Diagnostic love plot
model29.loveplot <- love.plot(model29.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "29. Northern Basin and Range: Prescribed burn") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model29.loveplot
...
model30.psm
summary(model30.psm) # 105 treated matched


# Diagnostic love plot
model30.loveplot <- love.plot(model30.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "30. Northern Basin and Range: Vegetation disturbance") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model30.loveplot
...
model31.psm
summary(model31.psm) # 542 treated matched


# Diagnostic love plot
model31.loveplot <- love.plot(model31.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "31. Northern Basin and Range: Post-burn aerial seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model31.loveplot
...
model32.psm
summary(model32.psm) # 88 treated matched


# Diagnostic love plot
model32.loveplot <- love.plot(model32.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "32. Northern Basin and Range: Post-burn aerial & drill seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model32.loveplot
...
model33.psm
summary(model33.psm) # 151 treated matched


# Diagnostic love plot
model33.loveplot <- love.plot(model33.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "33. Northern Basin and Range: Post-burn closure") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model33.loveplot
...
model34.psm
summary(model34.psm) # 217 treated matched


# Diagnostic love plot
model34.loveplot <- love.plot(model34.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "34. Northern Basin and Range: Post-burn drill seeding") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model34.loveplot
...
model35.psm
summary(model35.psm) # 370 treated matched


# Diagnostic love plot
model35.loveplot <- love.plot(model35.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "35. Northern Basin and Range: Post-burn herbicide") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model35.loveplot
...
model36.psm
summary(model36.psm) # 56 treated matched


# Diagnostic love plot
model36.loveplot <- love.plot(model36.psm, stars = "std",           
          thresholds = c(m = 0.2, v = 2)) +
  labs(title = "36. Northern Basin and Range: Post-burn seedling planting") +
  theme(legend.title = element_blank()) +
  theme(legend.position = "bottom")
model36.loveplot
...
model37.psm
summary(model37.psm) # 51 treated matched
...
model38.psm
summary(model38.psm) # 153 treated matched
...
model39.psm
summary(model39.psm) # 77 treated matched
...
model40.psm
summary(model40.psm) # 87 treated matched
...
model41.psm
summary(model41.psm) # 36 treated matched
...
model42.psm
summary(model42.psm) # 28 treated matched
...
model43.psm
summary(model43.psm) # 76 treated matched
...
model44.psm
summary(model44.psm) # 37 treated matched
...
model45.psm
summary(model45.psm) # 28 treated matched
...
model46.psm
summary(model46.psm) # 37 treated matched
...
count.table.psm <- count.table0 |> 
  mutate(
    Treated_n = c(
      ...
      summary(model39.psm)[[2]][4, 2], summary(model40.psm)[[2]][4, 2],
