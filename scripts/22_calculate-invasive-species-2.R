...
#   data with invasive species cover for each model for permutation tests 2.
...
save(list = ls(pattern = "\\.invasive$"), 
     file = "RData/22_invasive-matched-data-2.RData")


save.image("RData/22_calculate-invasive-species-2.RData")
