...
load("RData/20.2_PSM-2_updated.RData")
load("RData/20.2_g-computation-2_updated.RData")
load("RData/20.2_average-treatment-effect-2_updated.RData")
...
count.table.psm <- count.table0 |> 
  mutate(
    Control_n_before = c(
      ...
      summary(model43.psm)[[2]][2, 1], summary(model44.psm)[[2]][2, 1],
      summary(model45.psm)[[2]][2, 1], summary(model46.psm)[[2]][2, 1]
    )
  ) |> 
  mutate(
    Treated_n_before = c(
      ...
      summary(model43.psm)[[2]][2, 2], summary(model44.psm)[[2]][2, 2],
      summary(model45.psm)[[2]][2, 2], summary(model46.psm)[[2]][2, 2]
    )
  ) |> 
  mutate(
    Control_n_after = c(
      ...
      summary(model29.psm)[[2]][4, 1] - 1, summary(model30.psm)[[2]][4, 1],
      summary(model31.psm)[[2]][4, 1], summary(model32.psm)[[2]][4, 1] - 2,
      ...
      summary(model43.psm)[[2]][4, 1] - 1, summary(model44.psm)[[2]][4, 1],
      summary(model45.psm)[[2]][4, 1], summary(model46.psm)[[2]][4, 1]
    )
  ) |> 
  mutate(
    Treated_n_after = c(
      ...
      summary(model29.psm)[[2]][4, 2] - 1, summary(model30.psm)[[2]][4, 2],
      summary(model31.psm)[[2]][4, 2], summary(model32.psm)[[2]][4, 2] - 2,
      ...
      summary(model43.psm)[[2]][4, 2] - 1, summary(model44.psm)[[2]][4, 2],
